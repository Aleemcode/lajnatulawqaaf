      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 p-8 sm:p-12 bg-brand-mist/50 flex items-center justify-center">
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
            {/* Card 1: Lajnatul Awqaaf (Green/Mint Theme) */}
            <div className="bg-white rounded-3xl p-6 border border-emerald-500/20 shadow-clay space-y-5 flex flex-col justify-between">
              <div>
                {/* Header Banner */}
                <div className="p-3.5 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-center gap-2 mb-4">
                  <div className="w-6 h-6 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xs font-bold font-cairo">
                    ل
                  </div>
                  <span className="font-cairo font-bold text-sm text-emerald-950">Lajnatul Awqaaf</span>
                </div>
                ...
                <ul className="space-y-3 text-xs text-slate-700">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-2">
                      <span className="w-4 h-4 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center text-[10px] flex-shrink-0 mt-0.5 font-bold">
                        ✓
                      </span>
                      <span>{pt}</span>
                    </li>
              ...
              <div className="pt-2">
                <Link
                  href="/about"
                  className="w-full py-2.5 px-4 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white text-xs font-cairo font-bold flex items-center justify-between transition-all"
                >
